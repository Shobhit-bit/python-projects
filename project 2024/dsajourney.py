...
# def bin_search(arr,num_find):
#     num = int(len(arr)/2)
#     if num==0:
#         return False
#     if arr[num]==num_find:
#         return True
#     elif arr[num] > num_find:
#         return bin_search(arr[0:num],num_find)
#     elif arr[num]<num_find:
#         return bin_search(arr[num:len(arr)],num_find)

# def binary_search(arr,num_sea):
#     left_ind = 0
#     right_ind =len(arr) - 1
#     while (left_ind <= right_ind):
#         mid_index = (left_ind+right_ind)//2
#         mid_num = arr[mid_index]
#         if mid_num == num_sea:
#             return mid_index
#         if mid_num < num_sea:
#             left_ind = mid_index+1
#         if mid_num > num_sea:
#             right_ind = mid_index-1
#     return -1

# arr= [12,4,21,5,32,6,86,23,54]
# arr.sort()
